...
const AWARDS = [
  {
    year: "2014",
    titleHe: "פרס נשיא המדינה להתנדבות",
    titleEn: "Presidential Volunteer Award",
    icon: Award,
  },
  {
    year: "2017",
    titleHe: "פרס שר הקליטה",
    titleEn: "Immigration Minister Award",
    icon: Star,
  },
];

const MILESTONES = [
  { year: "2009", labelHe: "הקמת העמותה", labelEn: "Organization Founded" },
  {
    year: "2012",
    labelHe: "500 חיילים נתמכים",
    labelEn: "500 Soldiers Supported",
  },
  {
    year: "2014",
    labelHe: "פרס נשיא המדינה",
    labelEn: "Presidential Award",
  },
  {
    year: "2017",
    labelHe: "פרס שר הקליטה",
    labelEn: "Immigration Minister Award",
  },
  {
    year: "2020",
    labelHe: "200+ מתנדבים פעילים",
    labelEn: "200+ Active Volunteers",
  },
  {
    year: "2024",
    labelHe: "1,500+ חיילים בשנה",
    labelEn: "1,500+ Soldiers/Year",
  },
];
            ...
            {[
              {
                icon: Heart,
                titleHe: "ליווי אישי",
                titleEn: "Personal Mentoring",
                descHe: "מתנדבים מלווים חיילים בודדים לאורך כל השירות הצבאי",
                descEn:
              ...
              {
                icon: Shield,
                titleHe: "מיצוי זכויות",
                titleEn: "Rights Advocacy",
                descHe: "עזרה במיצוי כל הזכויות המגיעות לחיילים בודדים",
                descEn:
              ...
              },
              {
                ...
                descHe: "יצירת קהילה חמה ותומכת של חיילים בודדים ומתנדבים",
                descEn:
